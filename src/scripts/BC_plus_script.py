...
# Parameters:
DATA_DIR = "/Users/laithaustin/Documents/classes/rl/mine_agent/MineRL2021-Intro-baselines"  # path to where MineRL dataset resides (should contain "MineRLTreechop-v0" directory).
...
def train():
    ...
    network = NatureCNN((3, 64, 64), 7).to(device)
