...
class PPO(OnPolicyAlgorithm):
    ...
    def train(self) -> None:
        ...
        """
        # Move policy to the chosen self.device
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                if isinstance(self.action_space, spaces.Discrete):
                    # Convert discrete action from float to long and flatten
                ...
                if self.clip_range_vf is None:
                    ...
                    values_pred = rollout_data.old_values.to(self.device) + th.clamp(
                        values - rollout_data.old_values.to(self.device), -clip_range_vf, clip_range_vf
                    )
                value_loss = F.mse_loss(rollout_data.returns.to(self.device), values_pred)
